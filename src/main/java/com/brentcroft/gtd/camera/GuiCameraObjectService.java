 ...
 */
public class GuiCameraObjectService
{
    private GuiCameraObjectManager gom = new GuiCameraObjectManager();
    ...
    public void install( Properties properties )
    {
        ...
        gom.install( buildDefaultAdapters( properties ) );
        gom.install( buildSwingAdapters( properties ) );
    ...
    {
        List< GuiCameraObjectManager.AdapterSpecification > adapters = new ArrayList<>();
    ...
    private List< GuiCameraObjectManager.AdapterSpecification > buildSwingAdapters( Properties properties )
    {
        List< GuiCameraObjectManager.AdapterSpecification > adapters = new ArrayList<>();

        adapters.add( gom.newAdapterSpecification( AbstractButton.class, AbstractButtonGuiObject.class ) );
        adapters.add( gom.newAdapterSpecification( Component.class, ComponentGuiObject.class, new ComponentGuiObjectConsultant( properties ) ) );
    ...
    private List< GuiCameraObjectManager.AdapterSpecification > buildFxAdapters( Properties properties )
    {
        List< GuiCameraObjectManager.AdapterSpecification > adapters = new ArrayList<>();
    ...
    private List< GuiCameraObjectManager.AdapterSpecification > buildW3CAdapters( Properties properties )
    {
        List< GuiCameraObjectManager.AdapterSpecification > adapters = new ArrayList<>();

        adapters.add( gom.newAdapterSpecification( Text.class, W3cTextGuiObject.class ) );

        adapters.add( gom.newAdapterSpecification( HTMLElement.class, W3cHTMLElementGuiObject.class, new W3CHTMLElementGuiObjectConsultant( properties ) ) );
